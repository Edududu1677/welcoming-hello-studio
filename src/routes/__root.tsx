...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Gestor MiniMarket" },
      { name: "description", content: "Gestão completa de minimercado: estoque, vendas, compras, notas fiscais, preços e relatórios." },
      { property: "og:title", content: "Gestor MiniMarket" },
      { property: "og:description", content: "Gestão completa de minimercado: estoque, vendas, compras, notas fiscais, preços e relatórios." },
